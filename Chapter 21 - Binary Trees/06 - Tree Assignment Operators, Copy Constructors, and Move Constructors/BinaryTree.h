...
public:
	...
	BinaryTree() { root = nullptr; }												// Default constrctor
	~BinaryTree() { cout << "Destructor activated...\n"; removeSubTree(root); }		// Destructor
	BinaryTree(const BinaryTree<T>&);												// Copy constructor
	BinaryTree& operator=(const BinaryTree<T>&);									// Copy assignment operator
	BinaryTree(BinaryTree<T>&&);													// Move constructor
	BinaryTree& operator=(BinaryTree<T>&&);											// Move assignment operator 
...
//Copy constructor
template <class T>
BinaryTree<T>::BinaryTree<T>(const BinaryTree& SOURCE) {
...
BinaryTree<T>& BinaryTree<T>::operator=(const BinaryTree& SOURCE) {
	...
	cout << "Copy assignment operated activated...\n";
...
// Move constructor
template <class T>
BinaryTree<T>::BinaryTree<T>(BinaryTree&& source) {
...
template <class T>
BinaryTree<T>& BinaryTree<T>::operator=(BinaryTree<T>&& source) {

	cout << "Move assignment operated activated...\n";
