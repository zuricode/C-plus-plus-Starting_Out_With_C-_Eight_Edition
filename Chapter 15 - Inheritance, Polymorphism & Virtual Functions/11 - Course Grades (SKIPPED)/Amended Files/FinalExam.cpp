...
void FinalExam::print(ostream& strm) const {

    strm << "Final Exam Report\n";
    strm << "-----------------\n";
    strm << "No. of questions: " << numQuestions << "\n";
    strm << "Points per question: " << pointsEach << "\n";
    strm << "Missed questions: " << numMissed << "\n";
